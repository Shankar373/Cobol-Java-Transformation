"""OCCURS workload declaration.

Tests OCCURS clause for table/array definition.
"""
...
def occurs_workload() -> WorkloadDefinition:
    """Return the workload definition for OCCURS."""
    return WorkloadDefinition(
        workload_id="occurs",
        description="OCCURS clause — table/array definition",
        artifacts=(
            WorkloadArtifact(
                logical_name="occurs-stdout",
            ...
            WorkloadArtifact(
                logical_name="occurs-exit-status",
