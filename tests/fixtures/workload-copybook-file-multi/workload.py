...
records (record = 4+12+5 byte fields + LF = 22), then re-READs them with a
full-width AT END loop and processes the copied fields.
Record layout ends in the DEPT field (max 5 chars, no trailing blanks) so
GnuCOBOL's LINE SEQUENTIAL trailing-space trim never fires and both sides
